function attributeToString(t) {
  return (
    "string" != typeof t && "undefined" === (t += "") && (t = ""), t.trim()
  );
}
...
(window.theme = window.theme || {}),
    ...
    ((e = (function () {
      ...
      (e.prototype.checkResponsive = function (e, i) {
        ...
        if (
          ("window" === r.respondTo
            ...
            : "slider" === r.respondTo
            ? (s = c)
            : "min" === r.respondTo && (s = Math.min(l, c)),
      ...
      (e.prototype.lazyLoad = function () {
        ...
        if (
          ...
          for (
            var r = o - 1, a = n, c = s.$slider.find(".slick-slide"), l = 0;
  ...
  */
          ...
          .appendTo(e),
        {
          init: function () {
            (r = p.outerWidth()),
              ...
              i === e
                ? ((c = r), (a = s))
                : ((c = f.outerWidth()), (a = f.outerHeight())),
              (l = (o.width - r) / c),
              (d = (o.height - s) / a),
              (u = f.offset());
          },
      ...
      (t.fn.zoom = function (i) {
        return this.each(function () {
          ...
          if (!o.url) {
            ...
            if (
              (p &&
                (o.url = p.getAttribute("data-src") || p.currentSrc || p.src),
              !o.url)
            )
              return;
          }
              ...
              function e(e) {
                p.init(),
                  ...
                  c
                    .stop()
                    .fadeTo(
                      t.support.opacity ? o.duration : 0,
                      1,
                      !!t.isFunction(o.onZoomIn) && o.onZoomIn.call(a)
                    );
              }
              function i() {
                c.stop().fadeTo(
                  o.duration,
                  0,
                  !!t.isFunction(o.onZoomOut) && o.onZoomOut.call(a)
                );
              }
  ...
  function () {
    ...
    function r(t, e) {
      return (
        (t = "number" == typeof t || ot.test(t) ? +t : -1) > -1 &&
        0 == t % 1 &&
    ...
    function l(t, e, i, o) {
      ...
      return (
        (n = t === tt) ||
          (n = (t === (n = ft[i]) || (t != t && n != n)) && !mt.call(o, i)),
        n ? e : t
      );
    }
    function d(t) {
        ...
        (null == t || null == e || (!R(t) && !V(e))
          ...
          : (function (t, e, i, o, n, r) {
              var a = Mt(t),
                ...
                d = "[object Array]";
              a ||
                ("[object Arguments]" == (l = gt.call(t)) &&
                  (l = "[object Object]")),
                c ||
                  ("[object Arguments]" == (d = gt.call(e)) &&
                    (d = "[object Object]"));
              var u = "[object Object]" == l && !s(t);
              c = "[object Object]" == d && !s(e);
              return !(d = l == d) || a || u
                ? 2 & n ||
                  ((l = u && mt.call(t, "__wrapped__")),
                  (c = c && mt.call(e, "__wrapped__")),
                  !l && !c)
                  ? !!d &&
                    (r || (r = []),
                    (l = M(r, function (e) {
                      ...
                      : (r.push([t, e]),
                        ...
                        r.pop(),
                        e))
                  : i(l ? t.value() : t, c ? e.value() : e, o, n, r)
                : (function (t, e, i) {
                    switch (i) {
                      case "[object Boolean]":
                      case "[object Date]":
      ...
      return function n() {
        for (
          var s = -1,
            ...
            c = i.length,
            l = Array(c + r),
            d = this && this !== pt && this instanceof n ? o : t;
          ++a < c;
    ...
    function A(t, e, i, o, n, s) {
      ...
      return (
        l &&
          !r &&
          (i = t.constructor) != (o = e.constructor) &&
          "constructor" in t &&
          "constructor" in e &&
          !(
            "function" == typeof i &&
    ...
    function D(t) {
      ...
      if ("function" != typeof t) throw new TypeError("Expected a function");
      return (
        (e = Tt(e === tt ? t.length - 1 : qt(e), 0)),
        function () {
          for (
            var i = arguments, o = -1, n = Tt(i.length - e, 0), s = Array(n);
            ++o < n;
    ...
    function H(t) {
      return (
        ...
        U(t) &&
        mt.call(t, "callee") &&
        (!St.call(t, "callee") || "[object Arguments]" == gt.call(t))
      );
    }
    function U(t) {
    ...
    function F(t) {
      return (
        "[object Function]" == (t = R(t) ? gt.call(t) : "") ||
    ...
    function Q(t) {
      return (
        "string" == typeof t ||
        (!Mt(t) && V(t) && "[object String]" == gt.call(t))
      );
    }
    function W(t, e) {
      return e > t;
    ...
    function Z(e, i, o) {
      var n = X(i),
        s = m(i, n);
      null != o ||
        (R(i) && (s.length || !n.length)) ||
        ((o = i), (i = e), (e = this), (s = m(i, X(i))));
            ...
            a &&
              (e.prototype[o] = function () {
                ...
                if (r || i) {
                  ...
                  return (
                    (o.__actions__ = k(this.__actions__)).push({
                      func: n,
                      args: arguments,
                      thisArg: e,
                    }),
    ...
    var tt,
      ...
      pt =
        o(rt && at && "object" == typeof global && global) ||
        (dt !== (ut && ut.window) && dt) ||
        lt ||
        ut ||
    ...
    (c.prototype = d(a.prototype)),
      ...
      (a.indexOf = function (t, e, i) {
        var o = t ? t.length : 0;
        i =
          ((i = "number" == typeof i ? (0 > i ? Tt(o + i, 0) : i) : 0) || 0) -
          1;
        for (var n = e == e; ++i < o; ) {
          var s = t[i];
      ...
      (a.isBoolean = function (t) {
        return (
          !0 === t || !1 === t || (V(t) && "[object Boolean]" == gt.call(t))
        );
      }),
      (a.isDate = function (t) {
      ...
      (a.noop = function () {}),
      (a.reduce = O),
      (a.result = function (t, e, i) {
        return (
          (e = null == t ? tt : t[e]) === tt && (e = i), F(e) ? e.call(t) : e
        );
      }),
      (a.size = function (t) {
  ...
  (theme.visibilitySettings = {
    checkForVisibility: function (t, e, i) {
      ...
      const o = t.collections,
        ...
        y = +e.productId;
      ("all" === e.visibility ||
        ("product" === e.visibility && m === y) ||
        ("collection" === e.visibility && s) ||
        ("tag" === e.visibility && d) ||
        ("type" === e.visibility && f)) &&
        i();
    },
        ...
        i.attr("aria-expanded", "false"),
          i.on("click", function (i) {
            i.preventDefault(),
              ...
              "function" == typeof e &&
                (theme.ajaxCart.load(), theme.modal.open(t));
          });
      },
    };
  })()),
    ...
    return (
      (t.prototype = _.assignIn({}, t.prototype, {
          ...
          var t = _.map(
            ...
            function (t) {
              ...
              return "radio" === i || "checkbox" === i
                ? !!e[0].checked &&
                    ((o.value = e.val()), (o.index = e.data("index")), o)
                : ((o.value = e.val()), (o.index = e.data("index")), o);
            }
          );
        ...
        _updateMedia: function (t) {
          ...
          e.preview_image &&
            i.preview_image &&
            (o = e.preview_image.src === i.preview_image.src),
            t.featured_media &&
              !o &&
  ...
  (timber.drawersInit = function () {
    ...
    (timber.LeftDrawer = new timber.Drawers("NavDrawer", "left")),
      (timber.FilterDrawer = new timber.Drawers(
        "dbtfyCollectionFilter",
        "left"
      )),
      theme.settings.isSearchEnabled &&
          ...
          if (
            (i.each(function () {
              $(this).hasClass(o.config.openClass) &&
                ($(this).hasClass(o.config.drawerLeftClass) &&
                  timber.LeftDrawer.close(),
                $(this).hasClass(o.config.drawerRightClass) &&
                  timber.RightDrawer.close(),
                $(this).hasClass(o.config.drawerTopClass) &&
                  timber.TopDrawer.close(),
                $(this).hasClass(o.config.drawerBottomClass) &&
  ...
  (ShopifyAPI.updateCartNote = function (t, e) {
    fetch("/cart/update.js", {
      ...
      body: JSON.stringify({ note: attributeToString(t) }),
    })
      .then((t) => t.json())
      .then((t) => {
  ...
  (ShopifyAPI.addItemFromForm = function (t, e, i) {
    ...
    "object" == typeof t && t.data && "object" == typeof t.data
      ? ((n = t.data),
        (o =
          t.forms instanceof jQuery
            ? t.forms.get()
            : t.forms instanceof NodeList
            ? Array.from(t.forms)
            : Array(t.forms)))
      : ((n = $(t).serialize()),
        (o =
  ...
  (ShopifyAPI.getCart = async function (t) {
    return await fetch("/cart.js")
      .then((t) => t.json())
      .then(
        (e) => ("function" == typeof t ? t(e) : ShopifyAPI.onCartUpdate(e), e)
      )
      .catch(() => {});
  }),
    ...
    return (
      (init = function (t) {
        (settings = {
          ...
          theme.settings.enableCartMessage &&
            (window.initNotificationToast = !0),
          ...
          ($cartPageContainer = document.querySelector(
            settings.cartPageContainer
          )),
          ($formContainer = document.querySelectorAll(settings.formSelector)),
          ($checkoutSelector = document.querySelectorAll(
            settings.checkoutSelector
          )),
          ($cartCountSelector = document.querySelectorAll(
            settings.cartCountSelector
          )),
          ($cartCostSelector = document.querySelectorAll(
            settings.cartCostSelector
          )),
          ($addToCart =
            $formContainer.length &&
            Array.from($formContainer)
              .map((t) =>
                Array.from(t.querySelectorAll(settings.addToCartSelector))
              )
              .flat()),
          ($body = $(document.body)),
          (isUpdating = !1),
          ...
          adjustCart(),
          (defaultShopLocale = theme.variables.shopLocales.find(
            (t) => t.shop_locale.primary
          )),
          defaultShopLocale &&
            Shopify.locale === defaultShopLocale.shop_locale.locale &&
            (isDefaultShopLocaleSet = !0);
      }),
      (loadCart = function () {
        isLoaded ||
          (theme.cart
            ? "drawer" === theme.settings.cartType
              ? $cartDrawer.classList.contains(settings.drawerIsLoadingClass) &&
                cartUpdateCallback(theme.cart)
              : "modal" === theme.settings.cartType &&
                $cartModal.classList.contains(settings.drawerIsLoadingClass) &&
                cartUpdateCallback(theme.cart)
        ...
        $cartCountSelector.length &&
          $cartCountSelector.forEach((t) => {
            ...
            (t.innerText = e <= 99 ? e : "99+"),
              e <= 0
                ? (t.classList.add(settings.hiddenCountClass),
                  i && i.classList.remove(settings.bubbleLinkActiveClass))
                : (t.classList.remove(settings.hiddenCountClass),
          ...
          theme.settings.dbtfyCartSavings ||
            ($cartCostSelector.length &&
              $cartCostSelector.forEach((t) => {
                t.innerHTML = `<span class="money">${theme.Currency.formatMoney(
                  i,
      ...
      (formSubmitHandler = function (t, e) {
        if (
          (e && e.preventDefault(), t.hasAttribute("data-has-submit-listener"))
        )
          return;
          ...
          form && (t = form),
            t.length &&
              t.forEach((t) => {
                ...
                e &&
                  !e.classList.contains(settings.quantityErrorClass) &&
      ...
      (buildCart = async function (t) {
        ...
        $cartContainer.insertAdjacentHTML("afterbegin", e),
          ...
          "drawer" === theme.settings.cartType
            ...
            : "modal" === theme.settings.cartType &&
              (isCartPage ||
                ...
                window.initNotificationToast
                  ? theme.NotificationToast.init(".cart-message-toast-wrapper")
                  : (theme.modal.init(), theme.cartModal.init()))),
          (isUpdating = !1),
          (theme.cart = t),
      ...
      (adjustCart = function () {
        function t(t, e) {
          ...
          const i = document.querySelector(
            `${settings.cartProductSelector}[data-line="${t}"]`
          );
          i &&
            (i.classList.add(settings.isLoadingClass),
        ...
        ($quantityAdjust = document.querySelectorAll(
          ...
          ($quantityInput = document.querySelectorAll(
          ...
          ($cartNoteSelector = document.querySelectorAll(
            settings.cartNoteSelector
          )),
          $quantityAdjust.length &&
            $quantityAdjust.forEach((e) => {
              const i = function () {
                ...
                (r = validateQty(r)),
                  e.classList.contains(settings.quantityAddClass)
                    ? (r += 1)
                    : ((r -= 1), r <= 0 && (r = n ? 0 : 1)),
                  n ? t(n, r) : (s.value = r),
                  (i || isCartPage) && theme.loadingState.init(e);
              };
              Boolean(e.dataset.qtyListener) ||
                ((e.dataset.qtyListener = !0), e.addEventListener("click", i));
            }),
    ...
    return {
      init: function (e, i, o) {
        ...
        let g = "",
          v = "";
        function b() {
          if (o && sessionStorage.getItem(`toast-${l.className}-closed`))
            return;
              ...
              if (t.classList.contains(r)) {
                if (!o) {
                  ...
                  e.classList.add("cloned-toast"),
                    d.insertAdjacentHTML("afterbegin", e.outerHTML);
                }
                    ...
                    !(function () {
                      if (o) {
                        const t = theme.discountCode.getStoredDiscounts(),
                          e = theme.discountCode.getMostValuableDiscount(
                            t,
                            theme.cart
                          );
                        e
                          ? window.location.assign(
                              `/checkout?discount=${e.name}&locale=${Shopify.locale}`
                            )
                          : window.location.assign(
                              `/checkout?locale=${Shopify.locale}`
                            );
        ...
        function w(t, e) {
          if (
            (theme.closeTransition({ elementToTransition: t }),
            t.classList.remove(r),
            o)
          ) {
            if (!e) return;
            sessionStorage.setItem(`toast-${l.className}-closed`, "true"),
              clearInterval(p);
          } else
            setTimeout(function () {
        ...
        y && "drawer" === theme.settings.cartType
          ? ((g = document.querySelector("#CartDrawer")),
            (v = "js-drawer-open"))
          : y &&
            "modal" === theme.settings.cartType &&
            ((g = document.querySelector("#CartModal")), (v = "js-modal-open")),
          o
            ? p ||
              setTimeout(function () {
                b(), (p = setInterval(b, m));
  ...
  (theme.ProductQuantities = (function () {
    function t(t, e, i) {
      ...
      if (!o) return;
      const n = o.hasAttribute("data-remain-qty")
          ? +o.dataset.remainQty
          : +o.dataset.productQty,
        s = +i.value,
        r = t.querySelector(".qty-plus");
      n > 0
        ? s >= n
          ? (r && r.setAttribute("disabled", "disabled"), (i.value = n))
          : r && r.removeAttribute("disabled")
        : ((i.value = 1), r && r.setAttribute("disabled", "disabled")),
        0 === s &&
          n > 0 &&
          ((i.value = 1),
    ...
    return {
      setMaxQuantity: function (t, e, i) {
        if (t && i && e) {
          ...
          if (!t) return;
          const o = t.hasAttribute("data-remain-qty")
            ? +t.dataset.remainQty
      ...
      setVariantQuantities: async function (e, i, o) {
        ...
        n.length &&
          ...
          document.body.dispatchEvent(
            new Event("updatedProductRemainingQuantities")
          );
      },
        ...
        (t[s] = { loaded: !1 }),
          o.each(function (t) {
            ...
            if (0 === t) {
              ...
              i[s] = { $element: d, defaultId: l };
            }
            e[a] = { modelId: l, sectionId: s, $container: o, $element: c };
          }),
          window.Shopify.loadFeatures([
            { name: "shopify-xr", version: "1.0", onLoad: c },
          ]),
          e.length < 1 ||
            (window.Shopify.loadFeatures([
              { name: "model-viewer-ui", version: "1.0", onLoad: l },
            ]),
            ...
            setTimeout(() => {
              const t = document.querySelector(".shopify-model-viewer-ui"),
                e = new MutationObserver(() => {
                  !(function (t) {
                    ...
                    t.classList.contains("shopify-model-viewer-ui--fullscreen")
                      ? e.forEach((t) => {
              ...
              e.observe(t, { attributes: !0, childList: !1, subtree: !1 });
            }, 600));
      },
      removeSectionModels: function (i) {
        for (var o in e) {
          if (e.hasOwnProperty(o))
            e[o].sectionId === i && (e[o].modelViewerUi.destroy(), delete e[o]);
        }
        delete t[i];
      },
    };
        ...
        if (c.length) {
          ...
          if (d)
            switch (
              ...
              case e.html5:
                window.Shopify.loadFeatures([
                  { name: "video-ui", version: "1.1", onLoad: r },
                ]),
    ...
    function o(i) {
      i &&
        ((i = $(i)).hasClass(e) ||
          (i.addClass(e),
          t.$body.addClass(e),
          theme.trapFocus({ $container: i.find(".modal-content") }),
      ...
      init: function () {
        (t = i()),
          ...
          $(".modal").on("click", function (t) {
            const e = $(this);
            e.get(0).hasAttribute("data-modal-no-close") ||
              (t.target !== e[0] && t.target !== e.find(".modal-dialog")[0]) ||
              n(e);
          });
      },
      open: o,
  ...
  (theme.carousel = (function () {
    ...
    return {
      init: function (e) {
        ...
        if (
          (a || ((a = n.children().length), n.attr("data-count", a)),
          a <= s.slidesToShow && !c)
        )
          this.destroy(n);
        else {
      ...
      destroy: function (n) {
        n.hasClass(i) && (n.off("init", o), n.slick("unslick")),
          n.addClass(e),
          n.removeClass(t);
      },
    };
  ...
  (theme.backToTop = function () {
    ...
    t.length &&
      ($(window).scroll(function () {
        $(this).scrollTop() > 600
          ? t.addClass("btn-top-visible")
          : t.removeClass("btn-top-visible");
      }),
      t.click(function () {
        return (
          $("html, body").animate(
  ...
  (theme.trapFocus = function (t, e) {
    ...
    t.$container.off("keydown"),
      ...
      o.on("keydown", function (e) {
        9 !== e.which ||
          e.shiftKey ||
          (e.preventDefault(), t.$container.focus());
      });
  }),
  ...
  (theme.discountCode = {
    init: function (t) {
      ...
      i ||
        ...
        o &&
          (this.applyDiscount(o.name, o.type, o.amount, i),
          theme.showTheMostValuableDiscountInCart());
    },
    ...
    addDiscount: function (t, e, i, o) {
      ...
      if ((n.push({ name: t, type: e, amount: i }), "object" == typeof o))
    ...
    removeDiscount: function (t, e) {
      ...
      let o = !0;
      "object" == typeof e &&
        e.hasOwnProperty("needUpdate") &&
        (o = e.needUpdate);
      const n = i.filter((i) => {
        let o = !0;
        "object" == typeof e &&
          (o = Object.entries(e).every(
            ([t, e]) => i.hasOwnProperty(t) && i[t] === e
          ));
        return !(i.name === t && o);
      });
      sessionStorage.setItem("discounts", JSON.stringify(n)),
          ...
          "object" == typeof e &&
            (i = Object.entries(e).every(([e, i]) => {
              ...
              return (
                "object" == typeof i &&
                  i.checkFunction &&
                  i.checkFunction instanceof Function &&
                  (o = i.checkFunction(t)),
    ...
    destroyDiscount: function (t) {
      ...
      (sessionStorage.getItem("discount")
        ? sessionStorage.getItem("discount")
        : null) && sessionStorage.removeItem("discount");
      let n = t || null;
      function s() {
    ...
    function t() {
      ...
      t.length &&
        ...
        e.on("click", function () {
          const t = $(this);
          t.hasClass(i)
            ? (t.removeClass(i), t.attr("aria-selected", !1))
            : (t.addClass(i), t.attr("aria-selected", !0));
        }));
    }
    function e(t) {
      if (!t.length) return;
      ...
      let a = 0;
      theme.variables.bpSmall ? (a = r) : n && (a = s),
        $("html, body").animate(
      ...
      if (!i)
        return (
          ...
          void document.dispatchEvent(
            new CustomEvent("dbtfy:cartDiscountSaved")
          )
        );
      switch (i.type) {
        case "$":
  ...
  (theme.goToCheckoutWithDiscount = function () {
    function t(t) {
      ...
      i
        ? window.location.assign(
            `/checkout?discount=${i.name}&locale=${Shopify.locale}`
          )
          ...
          !(function (t) {
            ...
            e.hasClass("zoom-active")
              ...
              : (function (t) {
                  ...
                  var i = $(t).data("zoom");
                  $(t).zoom({ url: i }).addClass("zoom-active");
                })(e);
          })(this);
        });
    }
  ...
  (theme.syncedProductVariant = function (t, e) {
    ...
    for (let t = 1; t <= s; t++) {
      ...
      if (r && s) {
        let t = s
            .closest(".custom_swatch_elements")
            .querySelector(".single-option-radio__label"),
          e = t.dataset.label;
  ...
  (theme.openExternalLinksInANewTab = function () {
    ...
    for (let e = 0, i = t.length; e < i; e++)
      t[e].hostname !== window.location.hostname &&
        ((t[e].target = "_blank"), (t[e].rel = "noreferrer noopener"));
  }),
    ...
    return {
      init: function () {
        t.dbtfy_agree_to_terms && e.push("agree-to-terms"),
          t.dbtfy_delivery_date &&
            theme.settings.dbtfyDeliveryDateRequired &&
            e.push("delivery-date"),
          t.dbtfy_order_feedback &&
            theme.settings.dbtfyOrderFeedbackRequired &&
            e.push("order-feedback");
      },
      update: function (t) {
    ...
    t.attr("aria-expanded", "false"),
      ...
      t.on("click", function (t) {
        ...
        "true" === e.attr("aria-expanded")
          ...
          : (e.attr("aria-expanded", "true"), (i = !0)),
          e
            .closest(".mobile-nav__has-sublist")
            .toggleClass("mobile-nav--expanded", i)
            .next()
            .toggle();
      });
  }),
      ...
      (t.prototype = _.assignIn({}, t.prototype, {
            ...
            afterShow: function () {
              document.querySelectorAll(".fancybox-thumbs li").forEach((t) => {
                ...
                const o = document.querySelector(
                    `.product-single__thumbnail-badge[data-media-type="${i}"]`
                  ),
                  n = o && o.cloneNode(!0);
                n && t.appendChild(n);
              });
        ...
        initProductVariant: function () {
          ...
          (this.variants = new slate.Variants(e)),
            ...
            1 === this.variants.product.variants.length &&
              this.$container.trigger({
                type: "variantChange",
            ...
            $("body").on("ajaxCart.afterCartLoad", function (e, i) {
              $(t.selectors.singleOptionSelector, t.$container).trigger(
                "change"
              ),
                1 === t.variants.product.variants.length &&
                  t.$container.trigger({
                    type: "variantChange",
        ...
        initVariantsChange: function () {
          ...
          function e(t) {
            const e = $(t)
                ...
                .find(".single-option-radio__label"),
              i = e.attr("data-option-name"),
              o = $(t).val();
            e.html(
              `${i}: <span class="variant-label-option-value">${o}</span>`
            );
          }
          $(".single-option-selector__radio", t.$container).on(
            "change",
            function () {
              const i = $(
        ...
        showVariantMedia: function (t) {
          var e,
            ...
            n = $(
              `${this.selectors.productMediaWrapper}[data-media-id="${o}"]`
            ),
        ...
        triggerMediaChangeEvent: function (t) {
          $(this.selectors.productMediaWrapper, this.$container).trigger(
            "mediaHidden"
          ),
            $(this.selectors.productMediaWrapper, this.$container)
              .filter(`#ProductMediaWrapper-${t}`)
        ...
        createThumbnailCarousel: function () {
          ...
          if (
            !($(this.selectors.productThumbnail, this.$container).length < 2)
          ) {
            var i = {
              slidesToShow: 5,
              slidesToScroll: 1,
        ...
        createMediaCarousel: function () {
          ...
          this.isStackedLayout
            ? (enquire.register(theme.variables.mediaQuerySmall, {
                match: function () {
                  (n = $(
                    `${t.selectors.productMediaWrapper}.${t.classes.featuredMedia}`,
                    t.$container
                  )
                    .closest(t.selectors.productMediaFlexWrapper)
                    .index()),
                    theme.carousel.init({
                      slider: o,
                      slickOptions: s,
        ...
        setFeaturedMedia: function () {
          var t = $(this.selectors.productMediaGroup, this.$container)
            .find(
              ".slick-slide.slick-active " + this.selectors.productMediaWrapper
            )
            .attr("data-media-id");
        ...
        destroyMediaCarousel: function () {
          var t = $(this.selectors.productMediaGroup, this.$container);
          t.length &&
            (this.trapCarouselFocus(t, !0), theme.carousel.destroy(t));
        },
          ...
          function r() {
            ...
            if (o) {
              ...
              var r = $(
                  ...
                  this.$container
                ).find(`option[value="${o.id}"]`),
                a = r.data("inventory-quantity") || 0,
                c = r.data("inventory-policy"),
                l = s.items.reduce(
                  (t, e) => (e.id === o.id ? t + e.quantity : t),
                  0
                );
              function d() {
                $(e.selectors.addToCart, e.$container)
                  .removeClass("disabled")
                  .prop("disabled", !1),
                  $(e.selectors.addToCartText, e.$container).html(n.addToCart),
                  $(e.selectors.meta, e.$container).removeClass(
                    e.classes.soldout
                  );
                ...
                t.length &&
                  t.attr(
                    "href",
                    this.updateUrlParameter(t.attr("href"), "variant", o.id)
                  );
              }
              function u() {
                $(e.selectors.addToCart, e.$container)
              ...
              if (
                ...
                o.available
                  ? "shopify" === o.inventory_management && "continue" !== c
                    ? l < a
                      ...
                      : u.bind(this)()
                    : (d.bind(this)(),
                      "shopify" === o.inventory_management &&
                        "continue" === c &&
                        a <= 0 &&
                ...
                o.compare_at_price > o.price
                  ...
                  : ($(this.selectors.productPrice, this.$container)
                      ...
                      .attr("aria-label", n.regularPrice),
                    $(this.selectors.comparePrice, this.$container)
                      .html("")
            ...
            f.length &&
              m &&
              Currency.currentCurrency &&
              Currency.convertAll(m, Currency.currentCurrency),
        ...
        initStickyProductMeta: function () {
          const t = this,
            e = $(this.selectors.meta, this.$container).find(
          ...
          function i() {
            ...
            if (e.length && i.length) {
              ...
              s < n
                ...
                : n < s
                ? (r(e), a(i))
                : ((theme.variables.productPageSticky = !1), a(e), a(i));
            }
            function r(t) {
      ...
      (t.prototype = _.assignIn({}, t.prototype, {
        init: function () {
          ...
          this.cacheSelectors(),
            ...
            this.cache.$sortDropdown.on(
              "change",
              this.sortCollection.bind(this)
            ),
        ...
        setQueryParams: function () {
          this.cache.$sortDropdown.length &&
            (Shopify.queryParams = this.parseQueryString());
        },
        parseQueryString: function () {
          if (!location.search.length) return {};
          for (
            var t, e = {}, i = 0, o = location.search.substr(1).split("&");
            i < o.length;
            i++
          )
        ...
        sortCollection: function () {
          this.cache.$sortDropdown.length &&
            (Shopify.queryParams.page && delete Shopify.queryParams.page,
        ...
        listView: function () {
          sessionStorage.setItem("collection-view", "list"),
            this.cache.$gridButton.removeClass(
        ...
        gridView: function () {
          sessionStorage.setItem("collection-view", "grid"),
            ...
            this.cache.$listButton.removeClass(
              "collection-layout-button--active"
            ),
    ...
    return (
      (t.prototype = _.assignIn({}, t.prototype, {
        ...
        onBlockSelect: function (t) {
          var e = $(`.collection-${t.detail.blockId}:not(.slick-cloned)`).attr(
            "data-slick-index"
          );
  ...
  (theme.LogoList = (function () {
    ...
    return (
      (t.prototype = _.assignIn({}, t.prototype, {
        ...
        onBlockSelect: function (t) {
          var e = $(`.logo-${t.detail.blockId}:not(.slick-cloned)`).attr(
            "data-slick-index"
          );
          e && $(this.slider).slick("slickGoTo", e).slick("slickPause");
        },
  ...
  (theme.HeroSlider = (function () {
    function t(t) {
      ...
      function o(t, e) {
        ...
        0 !== t || e
          ? t > 0 &&
            !e &&
            o.querySelectorAll("*").length <= 1 &&
            (o = n && n.nextElementSibling)
          : (o = o && o.nextElementSibling);
        const s = o && o.querySelectorAll("*").length > 1,
          r = o && o.nextElementSibling,
          a = r && r.querySelectorAll("*").length > 1;
        i &&
          ((o && o.classList.contains("hero-section") && s) ||
          (o && !s && r.classList.contains("hero-section") && a)
            ? i.setAttribute("media", "all")
            : i.setAttribute("media", "not all"));
      }
      if (
        (o(),
    ...
    return (
      (t.prototype = _.assignIn({}, t.prototype, {
        ...
        onBlockSelect: function (t) {
          var e = $(`.hero-${t.detail.blockId}:not(.slick-cloned)`).attr(
            "data-slick-index"
          );
          e && $(this.slider).slick("slickGoTo", e).slick("slickPause");
        },
  ...
  (theme.PasswordHeader = (function () {
    ...
    return (
      (t.prototype = _.assignIn({}, t.prototype, {
        init: function () {
          $(".storefront-password-form .errors").length &&
        ...
        createMap: function () {
          ...
          return (function (t) {
            ...
            .fail(function () {
              ...
              Shopify.designMode &&
                e.parent().addClass(a).html(`<div class="${c}">${t}</div>`);
            });
        },
        onUnload: function () {
          0 !== this.$map.length &&
  ...
  (theme.Quotes = (function () {
    ...
    return (
      (t.prototype = _.assignIn({}, t.prototype, {
        ...
        onBlockSelect: function (t) {
          var e = $(`.quotes-${t.detail.blockId}:not(.slick-cloned)`).attr(
            "data-slick-index"
          );
          e && $(this.slider).slick("slickGoTo", e).slick("slickPause");
        },
  ...
  (theme.ProductGridSlider = (function () {
    function t(t) {
      var e = (this.$container = $(t)),
        i = e.attr("data-section-id"),
        o =
          ((this.slider = `#ProductGrid-${i}`), e.find(".slick-product-grid"));
      if (o.length) {
        var n = {
            arrows: o.data("arrows"),
            dots: o.data("dots"),
  ...
  (theme.Announcement = (function () {
    ...
    return (
      (t.prototype = _.assignIn({}, t.prototype, {
        ...
        onBlockSelect: function (t) {
          var e = $(
            `.announcement-${t.detail.blockId}:not(.slick-cloned)`
          ).attr("data-slick-index");
          e && $(this.slider).slick("slickGoTo", e).slick("slickPause");
        },
        onBlockDeselect: function () {
