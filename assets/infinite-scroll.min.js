...
(Ajaxinate.prototype.initialize = function () {
  ...
  (Ajaxinate.prototype.stopMultipleClicks = function (t) {
    t.preventDefault(),
      this.clickActive &&
        (theme.loadingState.init(this.nextPageLinkElement),
  ...
  (Ajaxinate.prototype.checkIfPaginationInView = function () {
    ...
    t <= window.innerHeight &&
      ...
      this.nextPageLinkElement &&
        (this.nextPageLinkElement.dataset.loadingImage
          ? (this.nextPageLinkElement.innerHTML = `<img src="${this.nextPageLinkElement.dataset.loadingImage}">`)
          : this.nextPageLinkElement.classList.add("icon-lg", "icon-spin"),
        (this.nextPageUrl = this.nextPageLinkElement.href),
        this.loadMore()));
  }),
